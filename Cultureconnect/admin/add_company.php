...
<div class="row justify-content-center">
    <div class="col-lg-7">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-800 mb-0">Register Entity</h2>
                ...
                <div class="row g-4">
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="company_name" class="form-control bg-light border-0 py-3" placeholder="e.g. Arts United" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="description" class="form-control bg-light border-0 py-3" rows="4" placeholder="Briefly describe the entity's cultural contribution..."></textarea>
                    </div>

                    <div class="col-md-12 mt-5">
                        <div class="d-flex gap-2">
                            <button type="submit" name="add_company" class="btn btn-purple px-5 py-3 fw-bold shadow-lg flex-grow-1">Register Entity <i class="fas fa-check ms-2"></i></button>
